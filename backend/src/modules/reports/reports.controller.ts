...
export class ReportsController {
  ...
  async generate(
    ...
    const result = await this.reportsService.generateStructuredBaseReport({
      ...
      dxaIncludeForearm: dto.dxaIncludeForearm,
      dxaForearmBmd: dto.dxaForearmBmd,
      dxaForearmTScore: dto.dxaForearmTScore,
      dxaForearmZScore: dto.dxaForearmZScore,
      dxaHasPreviousExam: dto.dxaHasPreviousExam,
      dxaAttachPreviousExam: dto.dxaAttachPreviousExam,
      dxaPreviousExamDate: dto.dxaPreviousExamDate,
      dxaPreviousLumbarBmd: dto.dxaPreviousLumbarBmd,
      dxaPreviousFemoralNeckBmd: dto.dxaPreviousFemoralNeckBmd,
      dxaPreviousTotalHipBmd: dto.dxaPreviousTotalHipBmd,
      dxaLimitationsEnabled: dto.dxaLimitationsEnabled,
      dxaLimitationTypes: dto.dxaLimitationTypes,
